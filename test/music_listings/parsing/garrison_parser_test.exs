defmodule MusicListings.Parsing.GarrisonParserTest do
  use ExUnit.Case, async: true

  alias MusicListings.Parsing.GarrisonParser
  ...
  describe "venue_name/0" do
    test "returns expected value" do
      assert "The Garrison" == GarrisonParser.venue_name()
    end
  end

  describe "event_selector/1" do
    test "returns expected events", %{index_html: index_html} do
      events = GarrisonParser.event_selector(index_html)
