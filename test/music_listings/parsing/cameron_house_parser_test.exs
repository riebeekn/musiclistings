defmodule MusicListings.Parsing.CameronHouseParserTest do
  use ExUnit.Case, async: true

  alias MusicListings.Parsing.CameronHouseParser
  ...
  describe "venue_name/0" do
    test "returns expected value" do
      assert "The Cameron House" == CameronHouseParser.venue_name()
    end
  end
