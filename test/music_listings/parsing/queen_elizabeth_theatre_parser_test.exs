defmodule MusicListings.Parsing.QueenElizabthTheatreParserTest do
  use ExUnit.Case, async: true

  alias MusicListings.Parsing.Performers
  alias MusicListings.Parsing.Price
  alias MusicListings.Parsing.QueenElizabthTheatreParser
  ...
  describe "source_url/0" do
    test "returns expected value" do
      assert "https://gateway.admitone.com/embed/live-events?venueId=5f2c38d9b49c22464830180a&order=asc" ==
  ...
  describe "venue_name/0" do
    test "returns expected value" do
      assert "Queen Elizabeth Theatre" == QueenElizabthTheatreParser.venue_name()
    end
  end

  describe "event_selector/1" do
    test "returns expected events", %{index_html: index_html} do
      events = QueenElizabthTheatreParser.event_selector(index_html)
  ...
  describe "next_page_url/1" do
    test "returns the next page url", %{index_html: index_html} do
      assert nil == QueenElizabthTheatreParser.next_page_url(index_html)
    end
  end
