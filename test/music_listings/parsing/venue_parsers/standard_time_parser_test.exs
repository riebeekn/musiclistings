defmodule MusicListings.Parsing.VenueParsers.StandardTimeParserTest do
  ...
  describe "source_url/0" do
    test "returns expected value" do
      assert "https://partners-endpoint.dice.fm/api/v2/events?page%5Bsize%5D=100&types=linkout%2Cevent&filter%5Bvenues%5D%5B%5D=Standard+Time&filter%5Bflags%5D%5B%5D=going_ahead&filter%5Bflags%5D%5B%5D=rescheduled" ==
