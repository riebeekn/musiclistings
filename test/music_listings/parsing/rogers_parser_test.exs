defmodule MusicListings.Parsing.RogersParserTest do
  use ExUnit.Case, async: true

  alias MusicListings.Parsing.Performers
  alias MusicListings.Parsing.Price
  alias MusicListings.Parsing.RogersParser
  ...
  describe "venue_name/0" do
    test "returns expected value" do
      assert "Rogers Centre" == RogersParser.venue_name()
    end
  end

  describe "event_selector/1" do
    test "returns expected events", %{index_html: index_html} do
      events = RogersParser.event_selector(index_html)
