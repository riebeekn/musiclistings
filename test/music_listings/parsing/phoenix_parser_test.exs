defmodule MusicListings.Parsing.PhoenixParserTest do
  use ExUnit.Case, async: true

  alias MusicListings.Parsing.Performers
  alias MusicListings.Parsing.PhoenixParser
  ...
  describe "venue_name/0" do
    test "returns expected value" do
      assert "The Phoenix Concert Theatre" == PhoenixParser.venue_name()
    end
  end

  describe "event_selector/1" do
    test "returns expected events", %{index_html: index_html} do
      events = PhoenixParser.event_selector(index_html)
