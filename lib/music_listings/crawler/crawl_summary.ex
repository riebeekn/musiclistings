defmodule MusicListings.Crawler.CrawlSummary do
  @moduledoc """
  ...
  defstruct [:new, :updated, :duplicate, :parse_errors, :errors, :parse_errors_dump, :errors_dump]
  ...
  defp summarize_payload(payload, acc) do
    case payload.status do
      ...
      :parse_error ->
        ...
        acc
        |> Map.update!(:parse_errors_dump, &[err | &1])
        |> Map.update!(:parse_errors, &(&1 + 1))
