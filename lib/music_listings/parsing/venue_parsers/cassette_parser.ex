defmodule MusicListings.Parsing.VenueParsers.CassetteParser do
  @moduledoc """
  Parser for extracing events from https://www.cassetteto.com
  """
  @behaviour MusicListings.Parsing.VenueParser

  alias MusicListings.Parsing.VenueParsers.BaseParsers.SquareSpaceParser

  @base_url "https://www.cassetteto.com"
  ...
  def event_id(event) do
    SquareSpaceParser.event_id(event, "cassette")
  end
