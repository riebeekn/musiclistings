defmodule MusicListings.Parsing.VenueParsers.ComfortZoneParser do
  @moduledoc """
  Parser for extracting events from https://ra.co/clubs/4665 (The Comfort Zone)
  """
