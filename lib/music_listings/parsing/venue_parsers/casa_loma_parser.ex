defmodule MusicListings.Parsing.VenueParsers.CasaLomaParser do
  @moduledoc """
  Parser for extracing events from Casa Loma (Summer Series), listed via Live Nation.
  """
  ...
  @live_nation_venue_id "KovZpZAkAnAA"
  @impl true
