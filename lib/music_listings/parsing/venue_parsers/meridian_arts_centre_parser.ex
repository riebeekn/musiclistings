defmodule MusicListings.Parsing.VenueParsers.MeridianArtsCentreParser do
  @moduledoc """
  Parser for extracing events from https://www.tolive.com/Meridian-Arts-Centre
  """
  ...
  def source_url,
    do:
      "https://cdn.contentful.com/spaces/nmxu5kj1b6ch/environments/master/entries?metadata.tags.sys.id%5Ball%5D=genreConcerts%2CmeridianArtsCentre&locale=en-US&include=1&limit=1000&order=-sys.createdAt"

  @impl true
  defdelegate retrieve_events_fun, to: ToLiveParser

  @impl true
  def example_data_file_location, do: "test/data/meridian_arts_centre/index.json"
