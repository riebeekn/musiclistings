defmodule MusicListings.Parsing.VenueParsers.HardLuckParser do
  @moduledoc """
  Parser for extracing events from https://hardluckbar.com/
  """
  ...
  @live_nation_venue_id "KovZpZAdndaA"
  @impl true
  ...
  @impl true
  def example_data_file_location, do: "test/data/hard_luck/index.json"
